...
public class ChatActivity extends BaseActivity implements OnChatLoadListener {
    ...
    private AppCompatEditText fieldMessage;
        ...
        ImageButton.OnClickListener onClickListener = view -> {
            switch (view.getId()) {
                case R.id.filter_button:
                    ...
                    tae_yang.setOnClickListener(view14 -> chatClient.connect("태양인", user.getUserID()));

                    tae_eum.setOnClickListener(view13 -> chatClient.connect("태음인", user.getUserID()));

                    so_yang.setOnClickListener(view1 -> chatClient.connect("소양인", user.getUserID()));

                    so_eum.setOnClickListener(view12 -> chatClient.connect("소음인", user.getUserID()));
